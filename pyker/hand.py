...
#             for _ in range(k):
#                 tiebreaker.append(item)
#             # tiebreaker += sorted(item)

#         # print(ranks_sorted)
#         # print(suits_sorted)
#         # print([str(card) for card in hand])
#         # print("tiebreak", tiebreaker)
...
#                 return (WinCategory.ROYAL_FLUSH, tiebreaker)
#             return (WinCategory.STRAIGHT_FLUSH, tiebreaker)

#         if ranks_sorted[0][0] == 4:
#             return (WinCategory.FOUR_OF_A_KIND, tiebreaker)
...
#         ):
#             return (WinCategory.FULL_HOUSE, tiebreaker)
#         if is_flush:
#             return (WinCategory.FLUSH, tiebreaker)
#         if is_straight:
#             return (WinCategory.STRAIGHT, tiebreaker)

#         if ranks_sorted[0][0] == 3:
#             return (WinCategory.THREE_OF_A_KIND, tiebreaker)

#         if len(ranks_sorted) == 3 and ranks_sorted[0][0] == 2:
#             return (WinCategory.TWO_PAIR, tiebreaker)
#         if len(ranks_sorted) == 4 and ranks_sorted[0][0] == 2:
#             return (WinCategory.PAIR, tiebreaker)

#         return (WinCategory.HIGH_CARD, tiebreaker)
...
#         # print("your hand", self)
#         # print("other hands", [str(h) for h in other_hands])
#         # print("hole", [str(card) for card in hole_cards])
#         # print(win_cond, other_win_conditions)

#         return 0

#     def monte_carlo(self, community_cards, player_count, n=1000):
...
#             win = self.winning_hand(new_hole, other_hands)
#             # print(win)
#             wins += win
#         # print(wins)
#         return wins / n
